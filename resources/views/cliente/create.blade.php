                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" name="tipo_persona" id="tipo_persona">
                            ...
                            <option value="fisica" {{ old('tipo_persona') == 'fisica' ? 'selected' : '' }}>Persona Fisica</option>
                            <option value="empresa" {{ old('tipo_persona') == 'empresa' ? 'selected' : '' }}>Empresa</option>
                        </select>
                        @error('tipo_persona')
                    ...
                    <div class="col-12" id="box-razon-social">
                        <label id="label-fisica" for="razon_social" class="form-label">Nombre Completo:</label>
                        <label id="label-empresa" for="razon_social" class="form-label">Nombre de la empresa:</label>
